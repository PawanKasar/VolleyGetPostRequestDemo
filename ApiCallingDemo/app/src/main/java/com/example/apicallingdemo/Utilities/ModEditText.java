package com.example.apicallingdemo.Utilities;
...
public class ModEditText extends EditText {
    ...
    public ModEditText(Context context, AttributeSet attrs) {
        super(context, attrs);
    }

    public ModEditText(Context context, AttributeSet attrs, int defStyle) {
